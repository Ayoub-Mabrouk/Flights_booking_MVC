...
authUser.getUserByCin(infoUser.cin).then((result) => {
    ...
    if (!infoUser) {
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0 navlinks">
            ...
            <li><a href="assets/pages/myreservations.html" class="nav-link px-2 link-dark">my Reserations</a></li>
            <li><a href="#" class="nav-link px-2 link-dark">About</a></li>
            <li><a href="#" class="nav-link px-2 link-dark">Contact</a></li>

        </ul>

       <span class="col-md-2 text-end navLogin">Welcome ${authUser.currentUser.first_name}</span>
        <div class="col-md-2 text-end navLogin">
            <button onclick="logout(event)" type="button" class="btn btn-primary">Logout</button>
        </div>
        `
        } else {
            nav.innerHTML = `
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0 navlinks">
            <li><a href="/" class="nav-link px-2 link-secondary">Home</a></li>
            <li><a href="assets/pages/flights.html" class="nav-link px-2 link-dark">Flights</a></li>
            <li><a href="#" class="nav-link px-2 link-dark">About</a></li>
            <li><a href="#" class="nav-link px-2 link-dark">Contact</a></li>
